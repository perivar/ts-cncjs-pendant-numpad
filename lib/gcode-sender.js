...
class GcodeSender {
    ...
    performZProbingTimes2() {
        ...
        this.sendMessage('command', 'gcode', 'G91'); // relative coordinates
        this.sendMessage('command', 'gcode', `G38.2 Z-${PROBE_DISTANCE} F${PROBE_FAST_FEEDRATE}`); // probe toward stock
        ...
        this.sendMessage('command', 'gcode', `G10 L20 P1 Z${TOUCH_PLATE_THICKNESS}`); // state that current Z is `TOUCH_PLATE_THICKNESS`
