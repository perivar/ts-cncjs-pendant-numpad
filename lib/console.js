...
function startCLI() {
    ...
    if (options.devicelist) {
        ...
        if (options.vendorId && options.productId) {
            const hidDevice = (0, numpad_controller_js_1.findHID)(options.vendorId, options.productId);
            if (hidDevice) {
    ...
    npmlog_1.default.trace(LOGPREFIX, 'Creating the Numpad controller instance.');
