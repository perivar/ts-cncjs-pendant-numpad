...
class Actions {
    ...
    //--------------------------------------------------------------------------
    restartSmoothJog() {
        npmlog_1.default.debug(LOGPREFIX, `Restarting smooth jogging timer, smoothJogging is ${this.smoothJogging}`);
        this.smoothJogging = false;
    ...
    //--------------------------------------------------------------------------
    stopSmoothJog() {
        npmlog_1.default.debug(LOGPREFIX, `Stopping smooth jogging, smoothJogging is ${this.smoothJogging}`);
        this.smoothJogging = false;
        clearTimeout(this.smoothJoggingTimer);
