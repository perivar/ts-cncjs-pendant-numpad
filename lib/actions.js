...
class Actions {
    ...
    constructor(connector, options) {
        ...
        this.joggingAck = true; // jog acknowledgement (true or false), start with it OK
    ...
    jogFunction() {
        ...
        this.jogTimer = setTimeout(this.jogFunction.bind(this), JOG_INTERVAL * (this.joggingAck ? 1 : 0.5));
